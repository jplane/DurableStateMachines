...
namespace StateChartsDotNet.Metadata.Fluent.Execution
{
    public sealed class ElseMetadata<TParent> : ExecutableContentMetadata where TParent : IModelMetadata
    {
        ...
        public ElseMetadata<TParent> Assign(string location, Expression<Func<IDictionary<string, object>, object>> getter)
        {
            var ec = new AssignMetadata<ElseMetadata<TParent>>();
        ...
        public ElseMetadata<TParent> Log(Expression<Func<IDictionary<string, object>, string>> getter)
        {
            var ec = new LogMetadata<ElseMetadata<TParent>>();
        ...
        public ElseMetadata<TParent> Execute(Expression<Action<IDictionary<string, object>>> action)
        {
