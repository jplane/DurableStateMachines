...
namespace StateChartsDotNet.Metadata.Fluent.States
{
    public sealed class OnEntryExitMetadata<TParent> : IOnEntryExitMetadata where TParent : IModelMetadata
    {
        ...
        public OnEntryExitMetadata<TParent> Assign(string location, Expression<Func<IDictionary<string, object>, object>> getter)
        {
            var ec = new AssignMetadata<OnEntryExitMetadata<TParent>>();
        ...
        public OnEntryExitMetadata<TParent> Log(Expression<Func<IDictionary<string, object>, string>> getter)
        {
            var ec = new LogMetadata<OnEntryExitMetadata<TParent>>();
        ...
        public OnEntryExitMetadata<TParent> Execute(Expression<Action<IDictionary<string, object>>> action)
        {
