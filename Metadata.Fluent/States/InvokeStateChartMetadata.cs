...
namespace StateChartsDotNet.Metadata.Fluent.States
{
    public sealed class InvokeStateChartMetadata<TParent> : IInvokeStateChartMetadata where TParent : IModelMetadata
    {
        ...
        public InvokeStateChartMetadata<TParent> ResultLocation(string location)
        {
        ...
        public InvokeStateChartMetadata<TParent> Assign(string location, Expression<Func<IDictionary<string, object>, object>> getter)
        {
            var ec = new AssignMetadata<InvokeStateChartMetadata<TParent>>();
        ...
        public InvokeStateChartMetadata<TParent> Log(Expression<Func<IDictionary<string, object>, string>> getter)
        {
            var ec = new LogMetadata<InvokeStateChartMetadata<TParent>>();
        ...
        public InvokeStateChartMetadata<TParent> Execute(Expression<Action<IDictionary<string, object>>> action)
        {
        ...
        string IInvokeStateChartMetadata.ResultLocation => _resultLocation;
