                                         ...
                                         'content': [
                                             {
                                                 ...
                                                 'type': 'sendmessage',
                                                 'activity': 'http-post',
                                                 'configtype': 'statechartsdotnet.common.httpsendmessageconfiguration',
                                                 'config': {
                                         ...
                                         'content': [
                                             {
                                                ...
                                                'activity': 'http-get',
                                                'resultlocation': 'x',
                                                'configtype': 'statechartsdotnet.common.httpqueryconfiguration',
                                                'config': {
                                                    'uri': 'http://localhost:4444/'
                                                }
                                             }
                                     ...
                                     'invokes': [
                                         {
                                             ...
                                             'finalize': [
                                                 { 'type': 'assign', 'location': 'innerX', 'expr': 'innerResults[""x""]' }
                                             ]
                                         }
                                     ],
                                     'transitions': [
